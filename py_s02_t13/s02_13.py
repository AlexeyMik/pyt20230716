# Задача №13. (Для решения в группах), данная версия сделана дома
...
# Output: 2
#======= среднедневные температуры заданы на входе в кортеже
t = (-20, 30, 0, -40, -50, 7, 10, -10, 8)
jPlusBest =0
jPlus=0
# print(len(t))
for i in range(len(t)):
    if t[i]>0 :
        ...
        if jPlus> jPlusBest: jPlusBest=jPlus
        jPlus=0
#    print(i, t[i],"  ",jPlus, jPlusBest)
print(jPlusBest)